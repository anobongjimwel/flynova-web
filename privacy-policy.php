...
<html lang="en">
    <head>
        ...
        <title>FlyNova - Privacy Policy</title>
    ...
    <body class="bg-dark">
        ...
        <div class="container-fluid" id="bookingContainer">
            <div class="row" style="background-color: rgba(255,255,255,0.85)">
                <div class="container">
                    <div class="row">
                        <div class="col-12 pb-3 pt-3" style="max-width: 50%; overflow-y: hidden"><h2>Privacy<span class="d-none d-md-inline">&nbsp;Policy</span></h2></div>
                    </div>
                </div>
            </div>
