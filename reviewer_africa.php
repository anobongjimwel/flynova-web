...
<html lang="en">
    ...
    <body class="bg-dark">
        ...
        <div class="container-fluid " style="min-height: 100vh; background-image: url('assets/img/home_bg/continents/egypt.png'); background-size: 150% 100%; background-position: center">
            <div class="row" style="background-color: rgba(255,255,255,0.49)">
                <div class="container">
                    <div class="row">
                        <div class="col-12 pb-3 pt-3"><h2>Africa Reviewer</h2></div>
                    </div>
                </div>
            </div>
            <div class="container pt-5 pb-5">
                <div class="row align-content-center" >
                    <div class="accordion w-100" id="accordionForAntarctica">
                        <?php $ctr = 1; ?>
                        <?php foreach (ReviewerHandler::getCountriesInContinent("Africa") as $country) { ?>
                        <div class="card">
