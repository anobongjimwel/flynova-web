<?php
    ...
    if (
        ...
        if (BookingHandler::checkBookingCounter($_SESSION['current_booking_simulation'], ProfileHandler::getProfile($_SESSION['username'], ProfileHandler::PROFILE_USERNAME)['id'])[0]==true) {
            echo "GOOD";
        } else {
            ...
            echo "-".$diminishedPoints."xp, ".BookingHandler::checkBookingCounter($_SESSION['current_booking_simulation'], ProfileHandler::getProfile($_SESSION['username'], ProfileHandler::PROFILE_USERNAME)['id'])[1];
        }
    } else {
        echo "BAD";
    }