<?php
    ...
    if (
        ...
        $matcher = BookingHandler::paymentMatch($_SESSION['current_booking_simulation'], ProfileHandler::getProfile($_SESSION['username'], ProfileHandler::PROFILE_USERNAME)['id']);
        if ($matcher[0] == true ) {
            echo "GOOD";
        } else {
            $diminishedPoints = 0;
