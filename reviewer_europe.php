...
<html lang="en">
    ...
    <body class="bg-dark">
        ...
        <div class="container-fluid " style="min-height: 100vh; background-image: url('assets/img/home_bg/continents/big-ben.png');background-size: 177.77% 100%; background-position: center">
            <div class="row" style="background-color: rgba(255,255,255,0.49)">
                <div class="container">
                    <div class="row">
                        <div class="col-12 pb-3 pt-3"><h2>Europe Reviewer</h2></div>
                    </div>
                </div>
            </div>
            <div class="container pt-5 pb-5">
                <div class="row align-content-center" >
                    <div class="accordion w-100" id="accordionForAntarctica">
                        <?php $ctr = 1; ?>
                        <?php foreach (ReviewerHandler::getCountriesInContinent("Europe") as $country) { ?>
                        <div class="card">
        ...
        <div class="container pt-5">
                <div class="row align-content-center" >
                    <div class="accordion w-100" id="accordionExample">
                        <div class="card">
                            <div class="card-header pb-0 pt-0 pl-2" id="headingOne">
                                <h2 class="mb-0">
                                    <button class="btn btn-link w-100 h-100 text-left" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        Antarctica
                                    </button>
                                </h2>
                            </div>
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="card-body pb-3 pt-3">
                                    <div class="row">
                                        <div class="col-md-6 col-lg-3 col-12 pb-3 pb-md-0">
                                            <h3><span class="bg-danger pl-1 pr-1">ASD</span></h3>
                                            <h5>Airport Name</h5>
